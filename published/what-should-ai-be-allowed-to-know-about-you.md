...
source_transcript: transcripts/what-should-ai-be-allowed-to-know-about-you.md
...
Personal AI assistants become more useful when they know our preferences,
history, documents, and plans. The same context can also let a system build a
private theory about our health, finances, relationships, or future without us
ever stating those facts directly.

This roundtable starts with an assistant that turns calendar access into a
sensitive family-planning inference, then tests the participants' rules against
salary documents, travel planning, debt, shopping history, and workplace data.
The discussion was grounded in the [NIST Privacy
Framework](https://www.nist.gov/privacy-framework), the UK Information
Commissioner's Office guidance on [security and data minimisation in
AI](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/guidance-on-ai-and-data-protection/how-should-we-assess-security-and-data-minimisation-in-ai/),
[lawfulness and AI-driven
inferences](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/guidance-on-ai-and-data-protection/how-do-we-ensure-lawfulness-in-ai/),
and [accuracy of personal-data
inferences](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/guidance-on-ai-and-data-protection/what-do-we-need-to-know-about-accuracy-and-statistical-accuracy/),
along with OpenAI's [Memory
FAQ](https://help.openai.com/en/articles/8590148-personalization-and-data-controls-faq).
...
The source run completed on 2026-07-21 with all 13 moderator and participant
...
substantive claims. One malformed generated phrase was clarified to reflect the
speaker's stated requirement that sensitive inferences be blocked. The models
did not browse or retrieve sources during their turns; the source packet
