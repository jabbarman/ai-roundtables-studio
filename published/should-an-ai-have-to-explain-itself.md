...
source_transcript: transcripts/should-an-ai-have-to-explain-itself.md
...
AI systems are often asked to explain themselves. But an explanation can be
evidence, a useful summary, a warning label, an appeal route, or just a fluent
story that makes a weak answer feel stronger than it is.

This roundtable starts with an AI-assisted mortgage denial, then tests the
participants' rules against medical triage, coding help, research citations, and
creative writing. The discussion was grounded in the [NIST AI Risk Management
Framework](https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-ai-rmf-10),
the [OpenAI Model Spec](https://model-spec.openai.com/), OpenAI's [reasoning
models guide](https://platform.openai.com/docs/guides/reasoning), Anthropic's
research on [chain-of-thought
faithfulness](https://www.anthropic.com/research/measuring-faithfulness-in-chain-of-thought-reasoning),
and the European Commission's [EU AI Act
...
The source run completed on 2026-07-10 with all 13 moderator and participant
