...
source_transcript: transcripts/who-should-control-powerful-ai.md
...
Powerful AI is often discussed as though someone simply needs to be "in
control." But developing a model, testing its risks, deciding what risk the
public should accept, enforcing a decision, and hearing an appeal are different
jobs. Giving all of them to a company or a government would concentrate both
technical and political power.

This Series One finale asks who may delay the release of a model that is useful
for cyber defence but whose safeguards can be bypassed. The discussion was
grounded in the European Commission's guidance on [general-purpose AI
obligations](https://digital-strategy.ec.europa.eu/en/faqs/guidelines-obligations-general-purpose-ai-providers),
the [NIST AI Risk Management Framework](https://airc.nist.gov/airmf-resources/airmf/5-sec-core/),
the UK AI Security Institute's [Frontier AI Trends
Report](https://www.aisi.gov.uk/frontier-ai-trends-report), the [OECD AI
Principles](https://www.oecd.org/en/topics/ai-principles.html), and the UN
Independent International Scientific Panel on AI's [preliminary
report](https://www.un.org/independent-international-scientific-panel-ai/en/preliminary-report).
...
The source run completed on 2026-09-13 with all 13 moderator and participant
turns marked `completed`. The published edition adds reader orientation, source
links, metadata, and formatting while preserving the generated speaker order
and substantive disagreement. One reference to "NIST-accredited" evaluators was
corrected because the cited NIST framework supplies public risk-management
standards rather than the accreditation asserted in the generated wording. The
models did not browse or retrieve sources during their turns; source summaries
were supplied in their prompts.
