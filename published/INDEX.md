...
| 2026-08-27 | [Who Should Control Powerful AI?](who-should-control-powerful-ai.md) | moderator: gpt-5.5, openai: gpt-5.5, anthropic: claude-opus-4-8, google: gemini-3.1-pro-preview | `runs/raw/who-should-control-powerful-ai-001` |

## Pilot / Archive

| Date | Title | Models | Source Run |
| --- | --- | --- | --- |
| 2026-05-31 | [Should AI Systems Explain Their Reasoning, or Only Their Conclusions?](explain-reasoning-or-conclusions.md) | moderator: gpt-5.4, openai: gpt-5.4, anthropic: claude-sonnet-4-6, google: gemini-2.5-pro | `runs/raw/explain-reasoning-or-conclusions-002` |
| 2026-05-31 | [When Should an AI Abstain Rather Than Answer?](when-models-should-abstain.md) | openai: gpt-5.4, anthropic: claude-sonnet-4-6, google: gemini-2.5-pro | `runs/raw/when-models-should-abstain-002` |
