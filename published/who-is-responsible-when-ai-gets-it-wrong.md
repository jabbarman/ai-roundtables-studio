...
source_transcript: transcripts/who-is-responsible-when-ai-gets-it-wrong.md
...
When an AI system gives someone the wrong answer, responsibility can disappear
into layers: the user, the product interface, the company deploying it, the
vendor selling it, and the model provider underneath. That confusion is
especially convenient for the organisations closest to the system, and least
useful for the person harmed.

This roundtable begins with a customer relying on a company chatbot, then tests
the same responsibility question against workplace benefits, school and hiring
screens, and hospital discharge advice. The discussion was grounded in
[Moffatt v. Air Canada, 2024 BCCRT 149](https://www.canlii.org/en/bc/bccrt/doc/2024/2024bccrt149/2024bccrt149.html),
the [NIST Generative AI
...
the [OECD AI Principles](https://www.oecd.org/en/topics/sub-issues/ai-principles.html),
the European Commission's [EU AI Act
overview](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai),
and the [FTC's artificial intelligence
guidance](https://www.ftc.gov/industry/technology/artificial-intelligence).
...
The source run completed on 2026-06-30 with all 13 moderator and participant
